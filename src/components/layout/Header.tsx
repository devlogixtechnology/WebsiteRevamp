              ...
              <div key={link.label} className="group relative py-2">
                <Link
                  ...
                  className={`flex items-center gap-1 text-sm font-medium transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-teal focus-visible:ring-offset-2 ${
                    isScrolled
                      ? "text-slate-700 hover:text-brand-teal-dark"
                ...
                >
                  ...
                  <ChevronDown
                    ...
                    className={`h-3.5 w-3.5 transition-transform duration-200 group-hover:translate-y-0.5 ${
                      isScrolled
                        ? "text-slate-500 group-hover:text-brand-teal-dark"
                    ...
                    {link.dropdown.map((item) => (
                      <Link
                        ...
                        className={`flex items-center gap-2.5 rounded-lg px-3 py-2.5 text-sm transition-colors ${
                          isScrolled
                            ? "text-slate-700 hover:bg-slate-100 hover:text-brand-teal-dark"
                        ...
                        <Link
                          ...
                          className={`flex items-center justify-between rounded-lg px-3 py-2 text-xs font-semibold transition-colors ${
                            isScrolled
                              ...
                              : "text-brand-teal-hover hover:bg-brand-teal-hover/10"
                          }`}
                        >
                          {link.dropdownFooter}
              ...
              link.dropdown ? (
                  ...
                  <div className="flex items-center justify-between rounded px-2">
                    <Link
                      ...
                      className={`flex-1 py-3 text-base font-medium transition-colors ${
                        isScrolled ? "text-slate-800 hover:text-brand-teal-dark" : "text-slate-200 hover:text-brand-teal-hover"
                      }`}
                    >
                      {link.label}
                    </Link>
                ...
                <Link
                  ...
                  className={`rounded px-2 py-3 text-base font-medium transition-colors ${
                    isScrolled
                      ? "text-slate-800 hover:bg-slate-100 hover:text-brand-teal-dark"
